...
"Our Services.",
"YouTube Video",
"YouTube Video background, only used when layout = Video.",
"Learn More",
"Button URL",
"Button link.",
...
"View work",
"Add a recent work gallery.",
"Our Work.",
"Section description.",
"A selection of work you can edit to show what you can do. We are capable of doing awesome things.",
"Enable/Disable lightbox usage on whole portfolio.",
"Add a Portfolio section showing projects.",
"Numbers",
"Add one or more number describing this project.",
"Add Number",
"Number",
...
"Contact Options",
"Contact Info.",
"Add a Contact section showing posts.",
...
"Center button",
"Whether button should be centered.",
"Page",
"of",
"Continue Reading..",
"Dribbble",
...
"Header Background",
"Background image used in header.",
"Custom Colors",
...
"Address Link",
"Address Link (used for linking address to external map like Google Maps).",
"Copyright",
"This is the footer copyright message.",
"Logos Gallery",
"Specify which gallery should be used for logos section.",
"Call To Action Title",
"Title of your Call To Action section displayed above footer.",
"Call To Action Subtitle",
"Subtitle of your Call To Action section displayed above footer.",
"If so, why don't you get in touch with us so we can talk about your projects.",
"Call To Action Button 1 Text",
"Text of the first button in the Call To Action section.",
"Call To Action Button 1 Link",
"Link of the first button in the Call To Action section.",
"Call To Action Buttons separator",
"Text separating the buttons in your Call To Action section.",
"Call To Action Button 2 Text",
"Text of the second button in the Call To Action section.",
"Call To Action Button 2 Link",
"Link of the second button in the Call To Action section.",
"Email address displayed in footer. When clicked on, it should open default email client on users device.",
"Background Image",
"Portfolio link",
"Link pointing to your porfolio page, for 'back to portfolio' button",
"Alternate splash",
"If set to yes, splash section will support custom title, subtitle and button.",
"Splash Title",
...
"Footer Sections",
"Display Logos",
"When set to \"yes\", logos section will be displayed above footer.",
"Display Call To Action",
"When set to \"yes\", call to action section will be displayed above footer.",
"Don't use gallery",
"Global",
"Open in lightbox",
"Should this project be opened in lightbox when displayed in project page.",
"Displayed above content in big font.",
"Add one or more features for this project.",
"Add Feature",
"Features Image",
"Image displayd besides features.",
"Send it",
"Category: %s",
"Tag: %s",
"Sharing makes you an awesome human being.",
"Share this project if you like it!",
"Search..",
"Go",
"Search...",
"Posted by",
